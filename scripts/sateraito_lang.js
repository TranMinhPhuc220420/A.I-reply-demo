const MyLang = {
  msgData: {
    ...
    "TXT_PASTE_SELECTION": chrome.i18n.getMessage('txt_paste_selection'),
    ...
    "TXT_FIND_THE_PROBLEM": chrome.i18n.getMessage('txt_find_the_problem'),
    "TXT_CHECK_CONTENT_REPLY": chrome.i18n.getMessage('txt_check_content_reply'),
    "TXT_SUGGEST_MEETING": chrome.i18n.getMessage('txt_suggest_meeting'),
    ...
    "TXT_PLACEHOLDER_ORIGINAL_TEXT_SUMMARY": chrome.i18n.getMessage('txt_placeholder_original_text_summary'),
    "TXT_PLACEHOLDER_ORIGINAL_TEXT_CHECK_PROBLEM": chrome.i18n.getMessage('txt_placeholder_original_text_check_problem'),
    "TXT_PLACEHOLDER_ORIGINAL_TEXT_CHECK_CONTENT_REPLY": chrome.i18n.getMessage('txt_placeholder_original_text_check_content_reply'),
    "TXT_PLACEHOLDER_ORIGINAL_TEXT_TO_SUGGEST_MEETING": chrome.i18n.getMessage('txt_placeholder_original_text_to_suggest_meeting'),
    ...
    "TXT_S_CHINESE": chrome.i18n.getMessage('txt_simplified_chinese'),
    "TXT_T_CHINESE": chrome.i18n.getMessage('txt_traditional_chinese'),
    ...
    "TXT_GENERATE_SUMMARY": chrome.i18n.getMessage('txt_generate_summary'),
    "TXT_GENERATE_FIND_PROBLEM": chrome.i18n.getMessage('txt_generate_find_problem'),
    "TXT_GENERATE_CHECK_CONTENT_REPLY": chrome.i18n.getMessage('txt_generate_check_content_reply'),
    "TXT_GENERATE_SUGGEST_MEETING": chrome.i18n.getMessage('txt_generate_suggest_meeting'),
    ...
    "DES_ERROR_TOPIC_COMPOSE_MAX_LENGTH_TOKEN": chrome.i18n.getMessage('des_error_empty_topic_compose_max_length_token'),
    "DES_ERROR_ORIGINAL_TEXT_REPLY": chrome.i18n.getMessage('des_error_empty_original_text_reply'),
    "DES_ERROR_ORIGINAL_TEXT_REPLY_MAX_LENGTH_TOKEN": chrome.i18n.getMessage('des_error_empty_original_text_reply_max_length_token'),
